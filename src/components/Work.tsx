 ...
 * made them hover to see one at a time. Three cards, one lead and two
 * paired, let all three be compared without moving anything. The cards were not deleted, they moved:
