  ...
  const content = <article className="group cursor-pointer" style={{
    animationDelay: `${index * 0.1}s`
      ...
      <div className="relative overflow-hidden mb-6 rounded-lg shadow-lg group-hover:shadow-xl transition-shadow duration-500 bg-card">
        <div className="aspect-[16/9] overflow-hidden flex items-center justify-center bg-muted/20">
          <img src={image} alt={title} className="w-full h-full object-contain transition-all duration-700 group-hover:scale-105 group-hover:brightness-110" />
        </div>
